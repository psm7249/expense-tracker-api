...
create user expensetrackeruser with password 'password';
create database expensetrackerdb with template=template0 owner=expensetrackeruser;
\connect expensetrackerdb;
alter default privileges grant all on tables to expensetrackeruser;
alter default privileges grant all on sequences to expensetrackeruser;
